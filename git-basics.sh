...
echo -e "\n>>> 2. Add README.md and .gitignore to staging"
...
echo -e "\n>>> 11. ls -a  # Listing files (using ls -a) in folder $WORKING_FOLDER :"
ls -a
...
echo -e "\n>>> 13. git log --pretty=format:"%h %s %ad" --graph --since=10.days --date=relative "
...
echo -e "\n>>> 24. concatenate line to file don:"
echo "$ echo \"Touched while away\" >>don "
        echo  "Touched while away"  >>don

echo -e "\n>>> 25. git status -s -b  # shows file done was modified:"
git status -s -b
...
echo -e "\n>>> 27. ls -a  # Listing files shows the whole gang is back together (from amy to george)."
ls -a
...
echo -e "\n>>> 31. cat ed  # (display contents of) file ed:"
cat ed 
...
echo -e "\n>>> 33. git reflog -n 3  # after checkout master:"
git reflog -n 3
...
echo -e "\n>>> 34f. git checkout master"
git checkout master

echo -e "\n>>> 34g. git branch -vv"
git branch -vv

echo -e "\n>>> 34h. ls -a  # Listing files shows the whole gang is back together (from amy to george)."
ls -a
