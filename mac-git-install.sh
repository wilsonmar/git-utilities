...
if [[ "$GIT_EDITOR" = *"sublime"* ]]; then
   ...
   subl --version
      # Sublime Text Build 3143
#   fancy_echo "Starting Sublime Text ..."
#   subl &
fi
